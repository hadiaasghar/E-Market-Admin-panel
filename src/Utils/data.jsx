...
import { FaBell, FaCar, FaClipboardList, FaDotCircle, FaFileArchive, FaGift, FaHome, FaLock, FaRegCheckCircle, FaRegClipboard, FaShoppingCart, FaUser, FaUserCog, FaUsers, FaUtensils } from "react-icons/fa";
...
export const cardData = [
  {
    ...
    icon: (
      <RiMoneyDollarBoxLine
        size={40}
        className="  p-1 font-bold rounded"
      />
    ),
  },
  {
  ...
  },
  {
    ...
    link: "/users",
    icon: (
      <FaUser size={40} className="  p-1 font-bold rounded" />
    ),
  },
  {
    title: "Total Drivers",
...
export const sidebarItems = [
  ...
  { title: "God's Eye", icon: <RiHomeGearFill />, path: "/gods-eye" },  // 2. God's Eye
...
export const tableData = [
  ...
  ['https://firebasestorage.googleapis.com/v0/b/foodies-3c1d9.appspot.com/o/images%2Fbar_food_1715686767301.png?alt=media&token=9429a78b-4062-42bb-8274-3848f4df8626', 'Role 1', 'Category 1', true],
  ['https://firebasestorage.googleapis.com/v0/b/foodies-3c1d9.appspot.com/o/images%2Fbar_food_1715686767301.png?alt=media&token=9429a78b-4062-42bb-8274-3848f4df8626', 'Role 2', 'Category 2', false],
  // Additional rows...
];
...
export const vendorsData = [
  {
    id: 1,
    image: 'https://firebasestorage.googleapis.com/v0/b/foodies-3c1d9.appspot.com/o/images%2Ffoodie_place_holder_1718095821863.png?alt=media&token=dc6c9ae0-f3d6-4230-96cd-7163f12ae4c7',
    name: 'iJul Store',
    email: 'i********@yopmail.com',
  ...
  {
      id: 3,
      image: 'https://firebasestorage.googleapis.com/v0/b/foodies-3c1d9.appspot.com/o/images%2FIMG_20181015_093712_306-removebg-preview_1722250396169.png?alt=media&token=58b37ac0-10be-469b-9947-8400d7ba39ae',
      name: 'Zuhoor uddin',
      email: 's********@test.com',
      date: 'Wed Jul 31 2024 5:43:55 AM',
      documents: true,
