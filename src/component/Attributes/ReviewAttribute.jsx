      ...
      <div className="p-8 rounded">
        ...
        <div className="overflow-x-auto shadow-sm hover:shadow-md rounded-e-md">
          ...
          <table className="min-w-full bg-white border">
            <thead>
              <tr className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-2">
                <th className="py-2 px-4 border col-span-2 lg:col-span-1 md:col-span-1">
                  ...
                  >
                    ...
                    <div>
                      <TbTriangleFilled
                        className={`transition-colors text-[.5rem] ${sortOrder === "asc"
                            ? "text-gray-500"
                            : "text-gray-300"
                          }`}
                      />
                      <TbTriangleInvertedFilled
                        className={`transition-colors text-[.5rem] ${sortOrder === "desc"
                            ? "text-gray-500"
                            : "text-gray-300"
                          }`}
                      />
                ...
                <th className="py-2 px-4 border col-span-1 text-sm md:text-md lg:text-xl">
                  Actions
                </th>
              </tr>
            </thead>
