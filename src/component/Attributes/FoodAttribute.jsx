...
import AttributeButtonCard from '../AllCards/AttributeButtonCard'
...
const FoodAttribute = () => {
  ...
  return (
    <div>
      <TitleHead title={"Foods"} desc={"Foods Attributes"} desc2={"> Foods "} link={"/foods"}/>
      <AttributeCard attributes={attributes} name="Food" />
      {/* <AttributeButtonCard name="Food" /> */}
    </div>
  )
}
