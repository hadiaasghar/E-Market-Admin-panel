      ...
      <div className="grid grid-cols-5 gap-5">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg ">
            <div className="overflow-x-auto scrollbar-custom">
              <table className="w-full mb-6 ">
                <thead className="bg-[#F8FAFD] text-gray-600">
                  <tr>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="mx-4 text-gray-500 font-medium">Subtotal</span>
                <hr className="flex-grow border-gray-300" />
              </div>
        ...
        <div className="col-span-5 md:col-span-2 lg:col-span-2 ">
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg my-3">
            <h2 className="text-xl font-bold mb-2">Restaurant</h2>
            <hr className="my-4  border border-gray-300" />
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/foodies-3c1d9.appspot.com/o/images%2Fdownload%20(13)_1718795790642.jfif?alt=media&token=f6f148d3-bebf-4e97-b006-bd9147b1279d"
                  alt=""
