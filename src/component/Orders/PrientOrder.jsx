...
const PrientOrder = () => {
  ...
  return (
    <div className="bg-white shadow-md hover:shadow-lg p-4 rounded mx-2 md:mx-5">
      <div className="text-xl text-right float-right p-1 border-red1 rounded-md border-2">
        <IoPrint />
      </div>
      <br />
              ...
              <tr key={item.id}>
                <td className="flex flex-col gap-2 py-2 items-center md:py-3">
                  ...
                  <div>
                    ...
                    <span className="inline-block bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded-lg">
                      {item.size}
                    </span>
                  </div>
                </td>
