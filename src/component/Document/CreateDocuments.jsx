          ...
          <fieldset className="border rounded-md w-full border-gray-300 p-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
              <div>
                ...
                <h1 className="text-sm text-gray-400">Insert document title</h1>
              </div>
              <div>
                <label htmlFor="documentFor">Document For</label>
                <select
                  id="documentFor"
                  {...register('documentFor', { required: 'Document For is required' })}
                  className="block w-full p-2 border border-gray-300 rounded"
                >
                ...
                <h1 className="text-sm text-gray-400">Select document for</h1>
              </div>
