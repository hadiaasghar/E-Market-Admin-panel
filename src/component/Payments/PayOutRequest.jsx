...
const PayOutRequest = () => {
  ...
  return (
    ...
    <div className="shadow-lg">
      <ButtonHead tab1={"Restaurant PayOut Request"} tab2={"Driver PayOut Request"} link={'/payout/requests/drivers'}/>
      <HeadingCard />
                    ...
                    <tr className="px-4 py-2 border">
                      <td className="py-2 px-4 flex justify-between items-start">
                        <div className="flex flex-col  gap-2 text-gray-500  font-semibold ">
                          ...
                          <button className="text-white bg-primary-900 text-sm hover:shadow-md px-3 py-1 rounded-md">
                            Cancel Request
                          </button>
