  ...
  return (
    <div className="relative border p-6 rounded-lg w-[80%] mx-auto my-10 ">
      <div className="flex justify-between  items-center">
        <h2 className="absolute -top-4 left-4 text-sm bg-primary-900 rounded-lg p-2 font-semibold text-white">USER DETAILS</h2>
        <div to="/add-wallet" className="absolute right-4 -top-4 bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-600">
        <AddWalletModel/>
        </div>
